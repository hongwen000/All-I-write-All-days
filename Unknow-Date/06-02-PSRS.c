...
//
//
//IMPORTANT:This version requires DATA_NUM/process_num is an int 
//IMPORTANT:Process_num should be NO MORE THAN than per_process_data_num
//
//
//**********************************************************
//#define DATA_NUM 18
...
void CheckArrayContain(int *DATA_NUM,int* p_g_raw_data, int* p_local_data,int per_process_data_num,int pid, int num_print_a_line)
{
...
int main()
{
	...
	//cin >> *DATA_NUM;
	*DATA_NUM=512*1024*1024/size(int);
	}
	MPI_Bcast(DATA_NUM,1,MPI_INT,0,MPI_COMM_WORLD);
	if(*DATA_NUM%process_num !=0)
	{
		cout <<"IMPORTANT:This version requires DATA_NUM/process_num is an int"<<endl;
		MPI_Finalize();
		return 0;
	}
	if(process_num > *DATA_NUM/process_num)
	{
		cout <<"IMPORTANT:Process_num should be NO MORE THAN than per_process_data_num"<<endl;
		MPI_Finalize();
		return 0;
	}
	...
	*/
	...
	//CheckArrayContain(DATA_NUM,p_g_raw_data,NULL,per_process_data_num,pid,NUM_PRINT_A_LINE);
